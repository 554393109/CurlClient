...
namespace FormsApp
{
    ...
    internal class External
    {
        ...
        internal delegate int CURL_PROGRESS_DELEGATE(IntPtr parm, double dlTotal, double dlNow, double ulTotal, double ulNow);
        ...
        internal delegate CURLIOERR CURL_IOCTL_DELEGATE(CURLIOCMD cmd, IntPtr parm);
        ...
        [DllImport(m_libCurlBase, CallingConvention = CallingConvention.StdCall, EntryPoint = "curl_easy_getinfo")]
        ...
        // libcurlshim imports
        [DllImport(m_libCurlShim, CallingConvention = CallingConvention.StdCall)]
